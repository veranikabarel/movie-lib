...
export const Header: React.FC = () => {
  return (
    <div className="flex flex-col gap-2 px-2 py-4 md:mx-auto md:items-center md:p-4 lg:w-2/3">
      <div className="flex items-center justify-center gap-2 md:mb-4">
        ...
        <h1 className="text-3xl md:text-4xl">Movie library</h1>
      </div>
      <div className="text-md md:text-2xl">Search for a movie, add it to the list or explore details!</div>
    </div>
  );
};
